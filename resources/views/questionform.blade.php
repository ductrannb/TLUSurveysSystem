...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/questionform.css') }}">
           ...
           <div class="form_option--question" action="">
            ...
            <form class="form_option--checkbox" action="">
                ...
                <div class="dropdown">
                 ...
                 {{-- short  answer --}}
                 <form class="form_option--answer" action="">
                    <h2 class="form_option--heading">Câu hỏi</h2>
                    <input class="input-answer" type="text" placeholder="Văn bản trả lời ngắn">
                    <div class="form_option--btn">
                        <p class="form_option--require">Bắt buộc</p>
                        <i class="fa-solid fa-toggle-on btn-icon-toggle"></i>
                        <img class="btn-icon-trash" src="{{ asset('img/trash.png') }}" alt="">
                ...
                <!--paragraph-->
                <form class="form_option--pharagrap" action="">
                    <h2 class="form_option--heading">Câu hỏi</h2>
                    <input class="input-paragraph" type="text" placeholder="Văn bản trả lời ngắn">
                    <div class="form_option--btn">
                        <p class="form_option--require">Bắt buộc</p>
                        <i class="fa-solid fa-toggle-on btn-icon-toggle"></i>
                        <img class="btn-icon-trash" src="{{ asset('img/trash.png') }}" alt="">
