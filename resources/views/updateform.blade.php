    ...
    <div class="app">
        <header class="header">
           ...
           <div class="form_option--question" action="">
                <h1 class="form_option--title">THỐNG KÊ KẾT QUẢ SỬ DỤNG CSDL Sách & Tạp chí điện tử Ngoại Văn và bộ dữ liệu Fiingroup</h1>
                ...
                <form class="form_option--selection" action="">
                    <h2 class="form_option--heading">1.Mức độ sử dụng các cơ sở dữ liệu tạp chí và sách<br> điện tử</h2>
                    <div class="form_selection">
                        ...
                        <input class="form_selection--one" type="radio"> Không thường xuyên <br>
                        <input class="form_selection--two" type="radio"> Thường xuyên   
            ...
            <form class="form_option--checkbox" action="">
                ...
                <div class="btn-done">Hoàn Thành</div>
           </div>
           <!-- Radio option -->
