            ...
            <div class="content">
                ...
                <form action="" class="form-insert">
                    <div class="form-insert-wrap">
                        <span>*</span>
                        <label for="form-input-1" class="form-insert-label"
                            >Họ và tên:</label
                        >
                        <input
                            type="text"
                ...
                <form action="" class="form-insert">
                    <div class="form-insert-wrap">
                        <span>*</span>
                        <label for="form-input-2" class="form-insert-label"
                            >Mã sinh viên:</label
                        >
                        <input
                            type="text"
                ...
                <form action="" class="form-insert">
                    <div class="form-insert-wrap">
                        <span>*</span>
                        <label for="form-input-3" class="form-insert-label"
                            >Email:</label
                        >
                        <input
                            type="email"
